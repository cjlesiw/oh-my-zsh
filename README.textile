...
@wget --no-check-certificate https://github.com/awkisopen/oh-my-zsh/raw/master/tools/install.sh -O - | zsh@
...
1. Clone the repository
  ...
  @git clone git://github.com/awkisopen/oh-my-zsh.git ~/.oh-my-zsh@
