...
@curl -L https://github.com/Olipro/oh-my-zsh/raw/ZL/tools/install.sh | zsh@

h4. via `wget`

@wget --no-check-certificate https://github.com/Olipro/oh-my-zsh/raw/ZL/tools/install.sh -O - | zsh@
